...
import { contentWidthPixels, useStylesBase, colors, spacing } from '../styledComponents';
...
const WhyVolunteering = () => {
  ...
  const { container, blockContainer, reasonsContainer, reasonContainer, body2, thickLine } = useStyles();
  return (
