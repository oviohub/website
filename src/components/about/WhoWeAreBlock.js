...
const teamMembers = [
  {
    ...
    aboutMe: 'After receiving a Master of Art in Conflict, Security, and Development from Sussex University, I started my career as a project manager for multiple social impact organizations around the world such as UNHCR. <br /><br />When I moved to San Francisco, I was shocked by local nonprofits struggling to leverage technology solutions. That is why I decided to co-create Ovio, a tech volunteering platform. I am most passionate about refugee rights and women’s rights. My appetite for social justice oriented my early career towards humanitarian and social activities.',
    photo: photoTiphaine,
  },
  {
    name: 'Eric Boucher',
    ...
    // eslint-disable-next-line max-len
    aboutMe: 'After a Master of Science, Management Science and Engineering at Stanford University, I started my career as a software engineer in the Silicon Valley. My desire to code for good led me to work for a tech nonprofit, Bayes Impact. <br /><br />Witnessing the huge need for technology in the social impact sector, I decided to co-create Ovio, a tech volunteering platform. I am passionate about climate change and human rights. Since graduate school, I have engaged my time and skills to support these causes.',
    photo: photoEric,
  },
  {
    name: 'Ben Peters',
    ...
    // eslint-disable-next-line max-len
    aboutMe: 'Ben is a data scientist and software engineer with experience working on web engineering and design, embedded systems, platform architecture, and machine learning. <br /><br />He studied Physics, Mechanical Engineering (with a focus on adaptive control theory), and Computer Science at Dartmouth College and has spent the past 9 years in a variety of software and analyst positions, ranging from programming smart HVAC systems for high performance homes to developing data pipelines, storage, and tools for an education startup working with satellites. <br /><br />Ben loves mountains and spends most of his free time skiing, rock climbing, and mountain biking.',
    photo: photoBen,
  },
];
            ...
            <Grid className={subContainer}>
              ...
              <Grid className={textContainer}>
                <Typography variant="body2">
                  <JsxParser renderInWrapper={false} jsx={aboutMe} />
                </Typography>
              </Grid>
            </Grid>
          </Grid>
