...
const teamMembers = [
  ...
  },
  {
    ...
    // eslint-disable-next-line max-len
    aboutMe: 'After a Master of Science, Management Science and Engineering at Stanford University, I started my career as a software engineer in the Silicon Valley. My desire to code for good led me to work for a tech nonprofit, Bayes Impact. \n\nWitnessing the huge need for technology in the social impact sector, I decided to co-create Ovio, a tech volunteering platform. I am passionate about climate change and human rights. Since graduate school, I have engaged my time and skills to support these causes.',
    photo: photoEric,
  },
  {
    name: 'Ben Peters',
    ...
    // eslint-disable-next-line max-len
    aboutMe: 'I am a data scientist and software engineer with experience working on web engineering and design, embedded systems, platform architecture, and machine learning.\n\nAfter studying Physics, Mechanical Engineering (with a focus on adaptive control theory), and Computer Science at Dartmouth College, I spent the past 9 years in a variety of software and analyst positions, ranging from programming smart HVAC systems for high performance homes to developing data pipelines, storage, and tools for an education startup working with satellites. I love mountains and spends most of my free time skiing, rock climbing, and mountain biking.',
    photo: photoBen,
  },
];
